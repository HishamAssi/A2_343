...
"JOIN cabinet ON cabinet.country_id = e.country_id WHERE ((cabinet.start_date >= e.e_start AND cabinet.start_date <= e.e_end) OR (cabinet.start_date >= e.e_start AND e.e_end is NULL )) AND (e.country_id = ?);";
